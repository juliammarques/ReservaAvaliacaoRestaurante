...
class UpdateStatusEncerradoReservaMesaUseCaseTest {

    @Mock
    private ReservaMesaDomainService service;

    @InjectMocks
    private UpdateStatusEncerradoReservaMesaUseCase useCase;

    private UpdateStatusEncerradoReservaMesaUseCase.Input input;
    ...
    public void setUp() {
        ...
        input = new UpdateStatusEncerradoReservaMesaUseCase.Input(1L);
    }
    ...
    void testExecute_ShouldCallAtualizaStatusEncerrado() {
        ...
        assertEquals(StatusReserva.ENCERRADA, capturado.getStatus());
    }

    @Test
    void testExecute_ShouldNotCallAtualizaStatusEncerradoWhenInputIsNull() {
        // Arrange: Passa um input nulo
        UpdateStatusEncerradoReservaMesaUseCase.Input nullInput = null;
